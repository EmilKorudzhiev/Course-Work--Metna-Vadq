  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: FutureBuilder(
            future: ref.read(individualPostNotifierProvider(postId).notifier).getPost(),
                      ...
                      builder: (context, snapshot) {
                        ...
                        return Consumer(
                          builder: (BuildContext context, WidgetRef ref,
                              Widget? child) {
                            final comments =
                                ref.watch(commentsNotifierProvider(postId));
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () async {
                    bool isCommentAdded = await ref.read(commentsNotifierProvider(postId).notifier).addComment(inputController.text);
                    ...
                    if (isCommentAdded) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Възникна грешка при добавянето на коментар!'),
                        ),
                      );
                    }
                ...
                Consumer(
                  builder: (context, ref, child) {
                    ...
                    return IconButton(
                        ...
                        onPressed: () {
                          ref.read(individualPostNotifierProvider(postId).notifier).likePost();
                        });
                  },
                ),
              ],
